...
//
//
//data class BorrowedBook(val title: String)
//
//@Composable
//fun BorrowedBooksScreen(navController: NavHostController,
...
//@Composable
//fun BorrowedBooksScreenPreview() {
////BorrowedBooksScreen(rememberNavController())
//    val borrowedBooks = listOf(
//        BorrowedBook("Book 1"),
//        BorrowedBook("Book 2"),
//        BorrowedBook("Book 3")
//    )
//    BorrowedBooksScreen(navController = rememberNavController(), borrowedBooks = borrowedBooks)
//}
